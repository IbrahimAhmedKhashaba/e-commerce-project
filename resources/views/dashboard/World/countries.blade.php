                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($countries as $country)
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="status_{{ $country->id }}" class="badge badge-pill badge-border @if($country->is_active == 'Active' || $country->is_active == 'مفعل') border-success @else border-danger @endif success lg">
