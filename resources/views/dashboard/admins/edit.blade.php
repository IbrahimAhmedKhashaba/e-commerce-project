                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('dashboard.admins.edit' , $admin->id) }}">{{ __('dashboard.edit') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="userinput1" class="form-control border-primary"
                                                     name="password" placeholder="{{ __('dashboard.password_message') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="userinput1" class="form-control border-primary"
                                                     name="password_confirmation" placeholder="{{ __('dashboard.password_message') }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    <optgroup label="{{ __('dashboard.select_status') }}">
                                                        <option @selected($admin->status == 'Active') value="1">{{ __('dashboard.active') }}</option>
                                                        <option @selected($admin->status == 'Inactive')  value="0">{{ __('dashboard.inactive') }}</option>
                                                    </optgroup>
                                                </select>
                                              </div>
                                        </div>
