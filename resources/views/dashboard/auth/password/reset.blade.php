            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form action="{{ route('dashboard.password.reset') }}" method="POST" class="form-horizontal" action="login-simple.html" novalidate>
                       @csrf
                      ...
                      <button type="submit" class="btn btn-outline-info btn-lg btn-block"><i class="ft-unlock"></i>{{ __('auth.reset_password') }}</button>
                    </form>
                  </div>
                </div>
